...
The code above was created by adapting the code in [MaterialUI](https://mui.com/material-ui/react-snackbar/) as shown below:
   ...
   <Table>
      ...
      <TableBody>
         ...
         <TableRow key={index}>
            ...
            <TableCell>{candidate.candidateJobStatus.interviewCompleted ? "Complete" : "Not Started"}</TableCell>
            <TableCell> {candidate.candidateJobStatus.interviewCompleted ? candidate.selected ? "Selected" : "Rejected" : "Not Available"}</TableCell>
            <TableCell>
